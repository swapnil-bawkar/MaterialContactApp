(function() {
    ...
    angular.module('myApp', ['ngMaterial','ngAria','ui.router'])
        .config(StateProvider)
        .service('UserFactory', require('./dashboard/user-factory.js'))
        .controller('DashboardController', require('./dashboard/controller.js'))
        .controller('UserController', require('./user/controller.js'))
        .controller('EditController', require('./user/edit/controller.js'))
